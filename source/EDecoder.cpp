...
EDecoder::EDecoder(				int 				serverVersion, 
								EWrapper*			callback, 
								EClientMsgSink*		clientMsgSink				) 
{
...
const char* EDecoder::processTickPriceMsg(			const char* 	ptr, 
													const char* 	endPtr			) 
{
...
const char* EDecoder::processTickSizeMsg(			const char* 	ptr, 
													const char* 	endPtr			) 
{
...
const char* EDecoder::processTickOptionComputationMsg( 				const char* 	ptr, 
																	const char* 	endPtr			) 
{
...
const char* EDecoder::processTickGenericMsg(				const char* 	ptr, 
															const char* 	endPtr				) 
{
...
const char* EDecoder::processTickEfpMsg(			const char* 	ptr, 
													const char* 	endPtr			) 
{
...
const char* EDecoder::processOrderStatusMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processErrMsgMsg(				const char* 	ptr, 
													const char* 	endPtr				) 
{
...
const char* EDecoder::processOpenOrderMsg(			const char* 	ptr, 
													const char* 	endPtr			) 
{
	...
	EOrderDecoder eOrderDecoder(			&contract, 
											&order, 
											&orderState, 
											version, 
											m_serverVersion				);
...
const char* EDecoder::processAcctValueMsg(				const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processPortfolioValueMsg(				const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processAcctUpdateTimeMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processNextValidIdMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processContractDataMsg(			const char* 		ptr, 
														const char* 		endPtr			) 
{
...
const char* EDecoder::processBondContractDataMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processExecutionDetailsMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processMarketDepthMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processMarketDepthL2Msg(				const char* 	ptr, 
															const char* 	endPtr				) 
{
...
const char* EDecoder::processNewsBulletinsMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processManagedAcctsMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processReceiveFaMsg(				const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processHistoricalDataMsg(				const char* 	ptr, 
															const char* 	endPtr			) 
{
	...
	for( int ctr = 0; ctr < itemCount; ++ctr ) 
	{
		...
		m_pEWrapper->historicalData( 			reqId, 
												bar						);
...
const char* EDecoder::processHistoricalDataUpdateMsg(			const char* 	ptr, 
																const char* 	endPtr			) 
{
...
const char* EDecoder::processScannerDataMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
	...
	for( int ctr = 0; ctr < numberOfElements; ++ctr ) 
	{
		...
		m_pEWrapper->scannerData( 			tickerId, 
											data.rank, 
											data.contract,
											data.distance, 
											data.benchmark, 
...
const char* EDecoder::processScannerParametersMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processCurrentTimeMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processRealTimeBarsMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processFundamentalDataMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processContractDataEndMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processOpenOrderEndMsg( 			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processAcctDownloadEndMsg(				const char* 	ptr, 
																const char* 	endPtr			) 
{
...
const char* EDecoder::processExecutionDetailsEndMsg(			const char* 	ptr, 
																const char* 	endPtr			) 
{
...
const char* EDecoder::processDeltaNeutralValidationMsg(				const char* 	ptr, 
																	const char* 	endPtr			) 
{
...
const char* EDecoder::processTickSnapshotEndMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processMarketDataTypeMsg(				const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processCommissionReportMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processPositionDataMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processPositionEndMsg(			const char* 	ptr, 
														const char* 	endPtr			) 														
{
...
const char* EDecoder::processAccountSummaryMsg(				const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processAccountSummaryEndMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processVerifyMessageApiMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processVerifyCompletedMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processDisplayGroupListMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processDisplayGroupUpdatedMsg(			const char* 	ptr, 
																const char* 	endPtr			) 
{
...
const char* EDecoder::processVerifyAndAuthMessageApiMsg(			const char* 	ptr, 
																	const char* 	endPtr			) 
{
...
const char* EDecoder::processVerifyAndAuthCompletedMsg(			const char* 	ptr, 
																const char* 	endPtr		) 
{
...
const char* EDecoder::processPositionMultiMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processPositionMultiEndMsg(			const char* 	ptr, 
															const char* 	endPtr		) 
{
...
const char* EDecoder::processAccountUpdateMultiMsg(				const char* 	ptr, 
																const char* 	endPtr		 	) 
{
	...
	m_pEWrapper->accountUpdateMulti( 				reqId, 
													account, 
													modelCode, 
													key, 
													value, 
...
const char* EDecoder::processAccountUpdateMultiEndMsg(			const char* 	ptr, 
																const char* 	endPtr			) 
{
...
const char* EDecoder::processSecurityDefinitionOptionalParameterMsg(			const char* 	ptr, 
																				const char* 	endPtr			) 
{
	...
	m_pEWrapper->securityDefinitionOptionalParameter(				reqId, 
																	exchange, 
																	underlyingConId, 
																	tradingClass, 
																	multiplier, 
...
const char* EDecoder::processSecurityDefinitionOptionalParameterEndMsg(				const char* 	ptr, 
																					const char* 	endPtr		) 
{
...
const char* EDecoder::processSoftDollarTiersMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
	...
	m_pEWrapper->softDollarTiers(			reqId, 
											tiers				);
...
const char* EDecoder::processFamilyCodesMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processSymbolSamplesMsg(				const char* 	ptr, 
															const char* 	endPtr			) 
{
	...
	m_pEWrapper->symbolSamples(				reqId, 
...
const char* EDecoder::processMktDepthExchangesMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processTickNewsMsg(			const char* 	ptr, 
													const char* 	endPtr			) 
{
...
const char* EDecoder::processNewsProvidersMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::processNewsArticleMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
	...
	m_pEWrapper->newsArticle(				requestId, 
											articleType, 
											articleText					);
...
const char* EDecoder::processHistoricalNewsMsg(				const char* 	ptr, 
															const char* 	endPtr			) 
{
	...
	m_pEWrapper->historicalNews(				requestId, 
												time, 
												providerCode, 
												articleId, 
												headline					);
...
const char* EDecoder::processHistoricalNewsEndMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
	...
	m_pEWrapper->historicalNewsEnd(				requestId, 
												hasMore					);
...
const char* EDecoder::processMarketRuleMsg(				const char* 	ptr, 
														const char* 	endPtr			)
{
	...
	m_pEWrapper->marketRule(			marketRuleId, 
										priceIncrements					);
...
int EDecoder::processConnectAck(			const char*& 	beginPtr, 
											const char* 	endPtr				)
{
...
const char* EDecoder::processSmartComponentsMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
	...
	for ( int i = 0; i < n; i++ ) 
	{
		...
		theMap[ bitNumber ] = std::make_tuple(			exchange, 
														exchangeLetter			);
	...
	m_pEWrapper->smartComponents(			reqId, 
											theMap				);
...
const char* EDecoder::processTickReqParamsMsg(			const char* 	ptr, 
														const char* 	endPtr		) 
{
	...
	m_pEWrapper->tickReqParams(					tickerId, 
												minTick, 
												bboExchange, 
												snapshotPermissions				);
...
const char* EDecoder::processHeadTimestampMsg(			const char* 		ptr, 
														const char* 		endPtr			) 
{
	...
	m_pEWrapper->headTimestamp(				reqId, 
											headTimestamp			);
...
const char* EDecoder::processHistogramDataMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
	...
	m_pEWrapper->histogramData(				reqId, 
											data				);
...
const char* EDecoder::processRerouteMktDataReqMsg(				const char* 	ptr, 
																const char* 	endPtr			) 
{
	...
	m_pEWrapper->rerouteMktDataReq(				reqId, 
												conId, 
												exchange				);
...
const char* EDecoder::processRerouteMktDepthReqMsg(			const char* 	ptr, 
															const char* 	endPtr			) 
{
	...
	m_pEWrapper->rerouteMktDepthReq(			reqId, 
												conId, 
												exchange			);
...
const char* EDecoder::processPnLMsg(			const char* 	ptr, 
												const char* 	endPtr			) 
{
...
const char* EDecoder::processPnLSingleMsg(			const char* 	ptr, 
													const char* 	endPtr		) 
{
...
template<typename T>
const char* EDecoder::processHistoricalTicks(			const char* 	ptr, 
														const char* 	endPtr			) 
{
...
const char* EDecoder::decodeTick(			HistoricalTick& 	tick, 
											const char* 		ptr, 
											const char* 		endPtr			) 											
{
												...
												bool 								done					) 
{
    ...
    m_pEWrapper->historicalTicks(				reqId, 
												ticks, 
												done						);
...
const char* EDecoder::decodeTick(			HistoricalTickBidAsk& 		tick, 
											const char* 				ptr, 
											const char* 				endPtr			) 
{
												...
												bool 										done			) 
{
    ...
    m_pEWrapper->historicalTicksBidAsk(				reqId, 
													ticks, 
													done				);
...
const char* EDecoder::decodeTick(			HistoricalTickLast& 	tick, 
											const char* 			ptr, 
											const char* 			endPtr			 	) 
{
												...
												bool 									done			) 
{
    ...
    m_pEWrapper->historicalTicksLast(			reqId, 
												ticks, 
												done				);
...
const char* EDecoder::processHistoricalTicksBidAsk(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processHistoricalTicksLast(			const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processTickByTickDataMsg(				const char* 	ptr, 
															const char* 	endPtr			) 
{
...
const char* EDecoder::processOrderBoundMsg(				const char* 	ptr, 
														const char* 	endPtr				) 
{
	...
	m_pEWrapper->orderBound( 				orderId, 
											apiClientId, 
											apiOrderId					);
...
const char* EDecoder::processCompletedOrderMsg(			const char* 	ptr, 
														const char* 	endPtr			) 
{
	...
	m_pEWrapper->completedOrder(			contract, 
											order, 
											orderState				);
...
const char* EDecoder::processCompletedOrdersEndMsg(				const char* 	ptr, 
																const char* 	endPtr			) 
{
...
const char* EDecoder::processReplaceFAEndMsg(			const char* 	ptr, 
														const char* 	endPtr				) 
{
	...
	m_pEWrapper->replaceFAEnd(				reqId, 
											text				);
...
int EDecoder::parseAndProcessMsg(			const char*& 	beginPtr, 
											const char* 	endPtr					) 
{
...
bool EDecoder::CheckOffset(				const char* 	ptr, 
										const char* 	endPtr				)
{
...
const char* EDecoder::FindFieldEnd(				const char* 	ptr, 
												const char* 	endPtr			)
{
...
bool EDecoder::DecodeField(				bool& 			boolValue, 
										const char*& 	ptr, 
										const char* 	endPtr					)
{
...
bool EDecoder::DecodeField(				int& 				intValue, 
										const char*& 		ptr, 
										const char* 	 	endPtr				)
{
	...
	const char* fieldEnd = FindFieldEnd(			fieldBeg, 
													endPtr				);
...
bool EDecoder::DecodeFieldTime(				time_t& 		time_tValue, 
											const char*& 	ptr, 
											const char* 	endPtr					)
{
...
bool EDecoder::DecodeField(				long long& 		longLongValue, 
										const char*& 	ptr, 
										const char* 	endPtr					)
{
...
bool EDecoder::DecodeField(				long& 			longValue, 
										const char*& 	ptr, 
										const char* 	endPtr				)
{
...
bool EDecoder::DecodeField(				double& 		doubleValue, 
										const char*& 	ptr, 
										const char* 	endPtr				)
{
...
bool EDecoder::DecodeFieldMax(				int& 			intValue, 
											const char*& 	ptr, 
											const char* 	endPtr				)
{
...
bool EDecoder::DecodeFieldMax(			long& 			longValue, 
										const char*& 	ptr, 
										const char* 	endPtr				)
{
	int intValue;
...
const char* EDecoder::decodeLastTradeDate(				const char* 		ptr, 
														const char* 		endPtr, 
														ContractDetails& 	contract, 
														bool 				isBond					) 
{
