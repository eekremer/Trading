...
public:
	...
	void 		reqContractDetails		(			int 						reqId, 
													const Contract& 			contract						);
	...
	void 		verifyRequest			(			const std::string& 			apiName, 
	...
	void 		subscribeToGroupEvents	(			int 						reqId, 
													int 						groupId							);
	
	void 		updateDisplayGroup		(			int 						reqId, 
	...
	void 		reqSecDefOptParams		(			int 						reqId, 				
	...
	void 		reqMatchingSymbols		(			int 						reqId, 
													const std::string& 			pattern							);
	
	void 		reqMktDepthExchanges	();
	
	void 		reqSmartComponents		(			int 						reqId, 
													std::string 				bboExchange						);
	
	void 		reqNewsProviders		();
	
	void 		reqNewsArticle			(			int 						requestId, 
													const std::string& 			providerCode, 
													const std::string& 			articleId, 
													const TagValueListSPtr& 	newsArticleOptions				);
	
	void 		reqHistoricalNews		(			int 						requestId, 
													int 						conId, 
	...
	void 		reqHeadTimestamp		(			int 						tickerId, 
													const Contract 				&contract, 
													const std::string& 			whatToShow, 
													int 						useRTH, 
													int 						formatDate						);
	...
	void 		reqHistogramData		(			int 						reqId, 
													const Contract 				&contract, 
													bool 						useRTH, 
...
protected:
	...
	virtual bool 	closeAndSend		(			std::string 				msg, 		
													unsigned 					offset = 0						) = 0;
