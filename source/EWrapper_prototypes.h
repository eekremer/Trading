...
virtual void 		tickPrice					( 			TickerId 			tickerId, 
															TickType 			field, 
															double 				price, 
															const TickAttrib& 	attrib			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		tickSize					( 			TickerId 			tickerId, 
															TickType 			field, 
															int 				size			) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		tickOptionComputation		( 			TickerId 			tickerId, 
															...
															double 				vega, 
															double 				theta, 
															double 				undPrice		) EWRAPPER_VIRTUAL_IMPL;

virtual void 		tickGeneric					(			TickerId 			tickerId, 
															TickType 			tickType, 
															double 				value			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		tickString					(			TickerId 			tickerId, 
															TickType 			tickType, 
															const std::string& 	value			) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		tickEFP						(			TickerId 			tickerId, 
															...
															double 				dividendsToLastTradeDate		) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		orderStatus					( 			OrderId 			orderId, 
															...
															double 				mktCapPrice			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		openOrder					( 			OrderId 			orderId, 
															const Contract&, 
															const Order&, 
															const OrderState&						) EWRAPPER_VIRTUAL_IMPL;

virtual void 		openOrderEnd				(													) EWRAPPER_VIRTUAL_IMPL;

virtual void 		winError					(			const std::string& 	str, 
															int 				lastError			) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		updateAccountValue			(			const std::string& 	key, 
															...
															const std::string& 	accountName			) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		contractDetails				( 			int 				reqId, 
															const ContractDetails& contractDetails	) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		execDetails					( 			int 				reqId, 
															...
															const Execution& 	execution			) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		updateMktDepthL2			(			TickerId 			id, 
															...
															double 				price, 
															int 				size, 
															bool 				isSmartDepth		) EWRAPPER_VIRTUAL_IMPL;

virtual void 		updateNewsBulletin			(			int 				msgId, 
															int 				msgType, 
															const std::string& 	newsMessage, 
															const std::string& 	originExch			) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		receiveFA					(			faDataType 			pFaDataType, 
															const std::string& 	cxml				) EWRAPPER_VIRTUAL_IMPL;

virtual void 		historicalData				(			TickerId 			reqId, 
															const Bar& 			bar					) EWRAPPER_VIRTUAL_IMPL;

virtual void 		historicalDataEnd			(			int 				reqId, 
															const std::string& 	startDateStr, 
															const std::string& 	endDateStr			) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		realtimeBar					(			TickerId 			reqId, 
															...
															long 				volume, 
															double 				wap, 
															int 				count				) EWRAPPER_VIRTUAL_IMPL;

virtual void 		currentTime					(			long 				time				) EWRAPPER_VIRTUAL_IMPL;

virtual void 		fundamentalData				(			TickerId 			reqId, 
															const std::string& 	data				) EWRAPPER_VIRTUAL_IMPL;

virtual void 		deltaNeutralValidation		(			int 				reqId, 
															const DeltaNeutralContract& deltaNeutralContract ) EWRAPPER_VIRTUAL_IMPL;

virtual void 		tickSnapshotEnd				( 			int 				reqId				) EWRAPPER_VIRTUAL_IMPL;

virtual void 		marketDataType				( 			TickerId 			reqId, 
															int 				marketDataType		) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		position					( 			const std::string& 	account, 
															const Contract& 	contract, 
															double 				position, 
															double 				avgCost				) EWRAPPER_VIRTUAL_IMPL;

virtual void 		positionEnd					(													) EWRAPPER_VIRTUAL_IMPL;

virtual void 		accountSummary				( 			int 				reqId, 
															const std::string& 	account, 
															const std::string& 	tag, 
															const std::string& 	value, 
															const std::string& 	curency				) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		verifyCompleted				( 			bool 				isSuccessful, 	
															const std::string& 	errorText			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		displayGroupList			( 			int 				reqId, 
															const std::string& 	groups				) EWRAPPER_VIRTUAL_IMPL;

virtual void 		displayGroupUpdated			( 			int 				reqId, 
															const std::string& 	contractInfo		) EWRAPPER_VIRTUAL_IMPL;

virtual void 		verifyAndAuthMessageAPI		( 			const std::string& 	apiData, 
															const std::string& 	xyzChallange		) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		accountUpdateMulti			( 			int 				reqId, 
															...
															const std::string& 	value, 
															const std::string& 	currency			) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		softDollarTiers				(			int 				reqId, 
															const std::vector<SoftDollarTier> &tiers) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		smartComponents				(			int 				reqId, 
															const SmartComponentsMap& theMap		) EWRAPPER_VIRTUAL_IMPL;

virtual void 		tickReqParams				(			int 				tickerId, 
															double 				minTick, 
															const std::string& 	bboExchange, 
															int 				snapshotPermissions	) EWRAPPER_VIRTUAL_IMPL;

virtual void 		newsProviders				(			const std::vector<NewsProvider> &newsProviders ) EWRAPPER_VIRTUAL_IMPL;

virtual void 		newsArticle					(			int 				requestId, 
															int 				articleType, 
															const std::string& 	articleText			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		historicalNews				(			int 				requestId, 
															const std::string& 	time, 
															const std::string& 	providerCode, 
															const std::string& 	articleId, 
															const std::string& 	headline			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		historicalNewsEnd			(			int 				requestId, 
															bool 				hasMore				) EWRAPPER_VIRTUAL_IMPL;

virtual void 		headTimestamp				(			int 				reqId, 
															const std::string& 	headTimestamp		) EWRAPPER_VIRTUAL_IMPL;

virtual void 		histogramData				(			int 				reqId, 
															const HistogramDataVector& data			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		historicalDataUpdate		(			TickerId 			reqId, 
															const Bar& 			bar					) EWRAPPER_VIRTUAL_IMPL;

virtual void 		rerouteMktDataReq			(			int 				reqId, 
															int 				conid, 
															const std::string& 	exchange			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		rerouteMktDepthReq			(			int 				reqId, 
															int 				conid, 
															const std::string& 	exchange			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		marketRule					(			int 				marketRuleId, 
															const std::vector<PriceIncrement> &priceIncrements) EWRAPPER_VIRTUAL_IMPL;

virtual void 		pnl							(			int 				reqId, 
															double 				dailyPnL, 
															double 				unrealizedPnL, 
															double 				realizedPnL			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		pnlSingle					(			int 				reqId, 
															int 				pos, 
															double 				dailyPnL, 
															double 				unrealizedPnL, 
															double 				realizedPnL, 
...
virtual void 		historicalTicks				(			int 				reqId, 
															...
															bool 				done				) EWRAPPER_VIRTUAL_IMPL;
...
virtual void 		tickByTickAllLast			(			int 				reqId, 
															int 				tickType, 
															time_t 				time, 
															double 				price, 
															int 				size, 
...
virtual void 		tickByTickBidAsk			(			int 				reqId, 
															time_t 				time, 
															double 				bidPrice, 
															double 				askPrice, 
															int 				bidSize, 
															int 				askSize, 
															const TickAttribBidAsk& tickAttribBidAsk) EWRAPPER_VIRTUAL_IMPL;

virtual void 		tickByTickMidPoint			(			int 				reqId, 
															time_t 				time, 
															double 				midPoint			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		orderBound					(			long long 			orderId, 
															int 				apiClientId, 
															int 				apiOrderId			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		completedOrder				(			const Contract& 	contract, 
															const Order& 		order, 
															const OrderState& 	orderState			) EWRAPPER_VIRTUAL_IMPL;

virtual void 		completedOrdersEnd			(													) EWRAPPER_VIRTUAL_IMPL;

virtual void 		replaceFAEnd				(			int 				reqId, 
															const std::string& 	text				) EWRAPPER_VIRTUAL_IMPL;
